...
// Set a default MongoDB URI if none is provided
if (!MONGODB_URI) {
  MONGODB_URI = "MONGO_URI_BACKUP";
  console.log("Warning: No MongoDB connection string provided. Using default local connection.");
}
